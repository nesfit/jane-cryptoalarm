...
class BothNotifyType extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        DB::beginTransaction();
        DB::statement("ALTER TABLE watchlists DROP CONSTRAINT watchlists_notify_check");
        DB::statement("ALTER TABLE watchlists ADD CONSTRAINT watchlists_notify_check CHECK (notify::text = ANY (ARRAY['email'::character varying, 'rest'::character varying]::text[]))");
        DB::commit();
    }
}
